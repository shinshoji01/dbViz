...
#declare -a ModelTypes=('resnet' 'vgg')
#
...
#python main.py --net $mod --load_net ./params/$mod/$seed.pth --plot_path ./images/paper/ --imgs 30,72,42 --set_seed $seed --range_l 0.5 --range_r 0.5
#
#done
#done
...
for seed in 0
do
python main.py --net WideResNet --widen_factor $wid --load_net ./params/WideResNet_$wid/$seed.pth --plot_path ./images/paper/ --imgs 30,72,42 --set_seed $seed --range_l 0.5 --range_r 0.5
done
done
